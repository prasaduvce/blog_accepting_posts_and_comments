...
public class BlogPostDAO {
    ...
    public void addPostComment(final String name, final String email, final String body,
    	...
    	Document postDocument = postsCollection.find(Filters.eq("permalink", permalink)).first();

    	postsCollection.updateOne(postDocument, new Document("$push", new Document("comments", comment)));
